...
class Gallery extends Component {
  ...
  activeImage = () => {
    ...
    return imagesList.filter(eachImage => eachImage.id === activeImageId)
  }
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        />
        <h1 className="dark-font">Nature Photography</h1>
        <p className="light-font">Nature Photography by Akisetti</p>
